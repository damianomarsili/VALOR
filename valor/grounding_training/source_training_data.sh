...
DATASETS=${DATASETS:-"omni3d-bench vsr"} # Space-separated list of datasets to process
START_INDEX=${START_INDEX:-0}
MAX_SAMPLES=${MAX_SAMPLES:-150} # Max per dataset, empty list "" means no limit.
SEED=${SEED:-2727}
...
MODEL_NAME=${MODEL_NAME:-"glab-caltech/VALOR-8B"}
...
cmd=(
  uv run --active -- python valor/grounding_training/source_training_data.py
